define("molecules/app/hint-float-ball-right/result_be6770f", ["san", "tslib", "@searchfe/inject-js", "@baidu/www-api"], function (n, o, r, i) {
  return s = cc11001100_hook("s", {
    ...
    4: function (t, e, n) {
      ...
      function h(t) {
        ...
        for (var e = cc11001100_hook("e", 0, "var-init"); e < t.length; e++) {
          ...
          if (o) {
            ...
            for (var i = cc11001100_hook("i", [], "var-init"), r = cc11001100_hook("r", 0, "var-init"); r < n.parts.length; r++) i.push(b(n.parts[r]));
      ...
      function b(e) {
        ...
        return o = cc11001100_hook("o", p ? (t = cc11001100_hook("t", a++, "assign"), r = cc11001100_hook("r", i = cc11001100_hook("i", i || v(), "assign"), "assign"), n = cc11001100_hook("n", m.bind(null, r, t, !1), "assign"), m.bind(null, r, t, !0)) : (r = cc11001100_hook("r", v(), "assign"), n = cc11001100_hook("n", function (t, e) {
