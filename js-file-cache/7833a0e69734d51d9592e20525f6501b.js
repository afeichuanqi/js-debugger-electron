//tealium universal tag - utag.1319 ut4.0.202303230638, Copyright 2023 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    ...
    u.map = cc11001100_hook("u.map", {
      ...
      "_sm_1319_2:conversion": cc11001100_hook("_sm_1319_2:conversion", "conversion", "object-key-init"),
    ...
    u.extend = cc11001100_hook("u.extend", [function (a, b) {
      try {
        b['_sm_1319_2'] = cc11001100_hook("b['_sm_1319_2']", "conversion", "assign");
      } catch (e) {
        utag.DB(e);
      }
      ...
      if (1) {
        ...
        c = cc11001100_hook("c", [{
          '/offers/collection/sustainability': cc11001100_hook('/offers/collection/sustainability', 'DC-9086737|tactical|tact02|standard', "object-key-init")
        }, {
          '/offers/collection/blackfriday2022': cc11001100_hook('/offers/collection/blackfriday2022', 'DC-9086737|tactical|tact03|standard', "object-key-init")
        }, {
          '/offers/collection/celebrate-the-holiday-season-with-cathay': cc11001100_hook('/offers/collection/celebrate-the-holiday-season-with-cathay', 'DC-9086737|tactical|tact04|standard', "object-key-init")
        }, {
          '/offers/flight/jan-on-plan-on-offer': cc11001100_hook('/offers/flight/jan-on-plan-on-offer', 'DC-9086737|tactical|tact05|standard', "object-key-init")
        }, {
          '/offers/vancouver-explorer': cc11001100_hook('/offers/vancouver-explorer', 'DC-9086737|tactical|trave0|standard', "object-key-init")
        }, {
          '/offers/discover-melbourne.html': cc11001100_hook('/offers/discover-melbourne.html', 'DC-9086737|tactical|trave00|standard', "object-key-init")
        }, {
          '/offers/collection/life-elevated-with-cathay-pacific': cc11001100_hook('/offers/collection/life-elevated-with-cathay-pacific', 'DC-9086737|tactical|tact01|standard', "object-key-init")
        }, {
          '/offers/flight/special-hdfc-offer.html': cc11001100_hook('/offers/flight/special-hdfc-offer.html', 'DC-9086737|tactical|tact07|standard', "object-key-init")
        }, {
          '/offers/student-campaign.html': cc11001100_hook('/offers/student-campaign.html', 'DC-9086737|tactical|trave000|standard', "object-key-init")
        }, {
          '/offers/collection/hong-kong-as-a-destination.html': cc11001100_hook('/offers/collection/hong-kong-as-a-destination.html', 'DC-9086737|tactical|tact06|standard', "object-key-init")
        }, {
          '/offers/collection/2023_hong_kong_as_a_hub_campaign.html': cc11001100_hook('/offers/collection/2023_hong_kong_as_a_hub_campaign.html', 'DC-9086737|tactical|tact08|standard', "object-key-init")
        }], "assign");
      ...
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        if (!u.hasgtagjs()) {
          ...
          u.loader({
            ...
            "id": cc11001100_hook("id", "utag_1319", "object-key-init"),
            "attrs": {}
          });
        }
        utag.DB("send:1319:COMPLETE");
      }
    }, "assign");
