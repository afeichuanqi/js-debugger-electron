//tealium universal tag - utag.430 ut4.0.202303230638, Copyright 2023 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
      ...
      try {
        if (b['application.name'] == 'RIBE') {
          ...
          window['adrum-config'] = cc11001100_hook("window['adrum-config']", function (a, c) {
            return {
              appKey: cc11001100_hook("appKey", 'AD-AAB-AAH-XYN', "object-key-init"),
              ...
              spa: {
                "spa2": cc11001100_hook("spa2", true, "object-key-init")
              },
              xd: {
              ...
              userEventInfo: {
                "PageView": function (context) {
                  return {
                    userPageName: cc11001100_hook("userPageName", b["page.page_id"], "object-key-init"),
                    userData: {
                      tealium_visitor_id: cc11001100_hook("tealium_visitor_id", b["tealium_visitor_id"], "object-key-init"),
                      registration_id: cc11001100_hook("registration_id", b["registration.registration_id"], "object-key-init"),
                      eum_errors: cc11001100_hook("eum_errors", b["js_page.errors"], "object-key-init"),
                      ribe_search_origin_airport: cc11001100_hook("ribe_search_origin_airport", b["search.params.origin.airport"], "object-key-init"),
                      ribe_search_destination_airport: cc11001100_hook("ribe_search_destination_airport", b["search.params.destination.airport"], "object-key-init"),
                      ribe_search_date_outbound: cc11001100_hook("ribe_search_date_outbound", b["search.params.date_outbound"], "object-key-init"),
                      ribe_search_date_inbound: cc11001100_hook("ribe_search_date_inbound", b["search.params.date_inbound"], "object-key-init"),
                      ribe_search_cabin_class: cc11001100_hook("ribe_search_cabin_class", b["search.params.cabin"], "object-key-init"),
                      ribe_search_trip_type: cc11001100_hook("ribe_search_trip_type", b["search.params.trip_type"], "object-key-init"),
                      ribe_itinerary_origin_airport: cc11001100_hook("ribe_itinerary_origin_airport", b["itinerary.origin.airport"], "object-key-init"),
                      ribe_itinerary_destination_airport: cc11001100_hook("ribe_itinerary_destination_airport", b["itinerary.destination.airport"], "object-key-init"),
                      ribe_itinerary_date_outbound: cc11001100_hook("ribe_itinerary_date_outbound", b["itinerary.outbound.datetime"], "object-key-init"),
                      ribe_itinerary_date_inbound: cc11001100_hook("ribe_itinerary_date_inbound", b["itinerary.inbound.datetime"], "object-key-init"),
                      ribe_itinerary_cabin_class: cc11001100_hook("ribe_itinerary_cabin_class", b["itinerary.cabin"], "object-key-init"),
                      ribe_itinerary_trip_type: cc11001100_hook("ribe_itinerary_trip_type", b["itinerary.trip_type"], "object-key-init"),
                      ribe_itinerary_route: cc11001100_hook("ribe_itinerary_route", b["itinerary.route"], "object-key-init"),
                      ribe_itinerary_segmented_flights: cc11001100_hook("ribe_itinerary_segmented_flights", b["itinerary.segmented_flights"], "object-key-init"),
                      ribe_ticket_currency: cc11001100_hook("ribe_ticket_currency", b["page.currency"], "object-key-init"),
                      rloc: cc11001100_hook("rloc", b["booking.pnr"], "object-key-init")
                    },
                    userDataLong: {
                      ribe_ticket_value: cc11001100_hook("ribe_ticket_value", parseFloat(b["custom_data.ibe.upsell_value_to"]), "object-key-init"),
                      ribe_search_pax_adult: cc11001100_hook("ribe_search_pax_adult", parseInt(b["search.params.pax.adult"]), "object-key-init"),
                      ribe_search_pax_child: cc11001100_hook("ribe_search_pax_child", parseInt(b["search.params.pax.child"]), "object-key-init"),
                      ribe_search_pax_infant: cc11001100_hook("ribe_search_pax_infant", parseInt(b["search.params.pax.infant"]), "object-key-init"),
                      ribe_itinerary_pax_adult: cc11001100_hook("ribe_itinerary_pax_adult", parseInt(b["itinerary.pax.adult"]), "object-key-init"),
                      ribe_itinerary_pax_child: cc11001100_hook("ribe_itinerary_pax_child", parseInt(b["itinerary.pax.child"]), "object-key-init"),
                      ribe_itinerary_pax_infant: cc11001100_hook("ribe_itinerary_pax_infant", parseInt(b["itinerary.pax.infant"]), "object-key-init")
                    }
                  };
                }
              }
    ...
    u.send = cc11001100_hook("u.send", function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = cc11001100_hook("u.data", {
          ...
          "base_url": cc11001100_hook("base_url", "//cdn.appdynamics.com/adrum/adrum-4.4.3.560.js", "object-key-init"),
        ...
        u.loader({
          ...
          "id": cc11001100_hook("id", "utag_430", "object-key-init"),
          "cb": cc11001100_hook("cb", u.callback, "object-key-init")
        });
        utag.DB("send:430:COMPLETE");
      }
    }, "assign");
