//tealium universal tag - utag.678 ut4.0.202303230638, Copyright 2023 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    ...
    u.map = cc11001100_hook("u.map", {
      "vendor_google_gtagconversion:conversion": cc11001100_hook("vendor_google_gtagconversion:conversion", "conversion", "object-key-init"),
      "search.params.origin.airport": cc11001100_hook("search.params.origin.airport", "custom.u1", "object-key-init"),
      "search.params.destination.airport": cc11001100_hook("search.params.destination.airport", "custom.u2", "object-key-init"),
      "search.params.pax.total": cc11001100_hook("search.params.pax.total", "custom.u3", "object-key-init"),
      "search.params.cabin": cc11001100_hook("search.params.cabin", "custom.u6", "object-key-init"),
      "page.locale": cc11001100_hook("page.locale", "custom.u7", "object-key-init"),
      "search.origin.airport": cc11001100_hook("search.origin.airport", "custom.u1", "object-key-init"),
      "search.destination.airport": cc11001100_hook("search.destination.airport", "custom.u2", "object-key-init"),
      "search.pax.total": cc11001100_hook("search.pax.total", "custom.u3", "object-key-init"),
      "search.params.trip_type": cc11001100_hook("search.params.trip_type", "custom.u17", "object-key-init"),
      "offer.promotion_code": cc11001100_hook("offer.promotion_code", "custom.u18", "object-key-init")
    }, "assign");
    ...
    u.send = cc11001100_hook("u.send", function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = cc11001100_hook("u.data", {
          ...
          "advertiser_id": cc11001100_hook("advertiser_id", "DC-9086737", "object-key-init"),
          "activity_group": cc11001100_hook("activity_group", "catha0", "object-key-init"),
          "activity": cc11001100_hook("activity", "pc_tt0", "object-key-init"),
        ...
        if (!u.hasgtagjs()) {
          ...
          u.loader({
            ...
            "id": cc11001100_hook("id", "utag_678", "object-key-init"),
            "attrs": {}
          });
        }
        utag.DB("send:678:COMPLETE");
      }
    }, "assign");
