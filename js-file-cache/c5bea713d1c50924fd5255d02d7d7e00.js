...
(function (window) {
  ...
  var ready = function (fn) {
    ...
    function IEContentLoaded(w, fn) {
      ...
      var d = cc11001100_hook("d", w.document, "var-init"),
        done = cc11001100_hook("done", false, "var-init"),
        init = function () {
          if (!done) {
            done = cc11001100_hook("done", true, "assign");
            fn();
          }
        };
      ...
      polling();
      d.onreadystatechange = cc11001100_hook("d.onreadystatechange", function () {
        if (d.readyState == "complete") {
          d.onreadystatechange = cc11001100_hook("d.onreadystatechange", null, "assign");
          init();
        }
      }, "assign");
    }
  ...
  function appendSvg() {
    ...
    div.innerHTML = cc11001100_hook("div.innerHTML", svgSprite, "assign");
    svgSprite = cc11001100_hook("svgSprite", null, "assign");
    svg = cc11001100_hook("svg", div.getElementsByTagName("svg")[0], "assign");
    if (svg) {
      svg.setAttribute("aria-hidden", "true");
      svg.style.position = cc11001100_hook("svg.style.position", "absolute", "assign");
      svg.style.width = cc11001100_hook("svg.style.width", 0, "assign");
      svg.style.height = cc11001100_hook("svg.style.height", 0, "assign");
      svg.style.overflow = cc11001100_hook("svg.style.overflow", "hidden", "assign");
      prepend(svg, document.body);
    }
  }
  if (shouldInjectCss && !window.__iconfont__svg__cssinject__) {
    window.__iconfont__svg__cssinject__ = cc11001100_hook("window.__iconfont__svg__cssinject__", true, "assign");
    try {
...
(function (window) {
  ...
  function Notifier() {}
  ;
  window.Notifier = cc11001100_hook("window.Notifier", Notifier, "assign");
  type = cc11001100_hook("type", 1, "assign");
  queue = cc11001100_hook("queue", [], "assign");
  t = cc11001100_hook("t", 5, "assign");
  c = cc11001100_hook("c", 3, "assign");
  _notifier = cc11001100_hook("_notifier", undefined, "assign");
  if (undefined !== window.webkitNotifications) {
    _notifier = cc11001100_hook("_notifier", window.webkitNotifications, "assign");
  } else if (undefined !== window.Notification) {
    _notifier = cc11001100_hook("_notifier", window.Notification, "assign");
  } else {
    // console.log('error not found notification!')
  }
  window.Notifier.ModelAll = cc11001100_hook("window.Notifier.ModelAll", function () {
    type = cc11001100_hook("type", 1, "assign");
  }, "assign");
  window.Notifier.ModelUpdate = cc11001100_hook("window.Notifier.ModelUpdate", function () {
    type = cc11001100_hook("type", 2, "assign");
  }, "assign");
  window.Notifier.ModelCount = cc11001100_hook("window.Notifier.ModelCount", function (ct) {
    if (ct !== undefined) c = cc11001100_hook("c", ct, "assign");
    type = cc11001100_hook("type", 3, "assign");
  }, "assign");
  window.Notifier.ModelTimeout = cc11001100_hook("window.Notifier.ModelTimeout", function (timeout) {
    if (timeout !== undefined) t = cc11001100_hook("t", timeout, "assign");
    type = cc11001100_hook("type", 4, "assign");
  }, "assign");
  window.Notifier.HasSupport = cc11001100_hook("window.Notifier.HasSupport", function () {
    if (undefined === _notifier) {
      return false;
    }
    return true;
  }, "assign");
  window.Notifier.GetPermission = cc11001100_hook("window.Notifier.GetPermission", function () {
    return _notifier.checkPermission();
  }, "assign");
  window.Notifier.IsGetPermission = cc11001100_hook("window.Notifier.IsGetPermission", function () {
    return _notifier === 0;
  }, "assign");
  window.Notifier.Disable = cc11001100_hook("window.Notifier.Disable", function () {
    return _notifier.checkPermission === 2;
  }, "assign");
  window.Notifier.RequestPermission = cc11001100_hook("window.Notifier.RequestPermission", function (cb) {
    _notifier.requestPermission(function () {
      if (cb) {
        cb(_notifier.checkPermission() == 0);
      }
    });
  }, "assign");

  //type = 1;关闭上一个
  window.Notifier.Close = cc11001100_hook("window.Notifier.Close", function (type) {
    if (type = cc11001100_hook("type", 1, "assign")) {
      tmp = cc11001100_hook("tmp", queue.pop(), "assign");
    } else {
      tmp = cc11001100_hook("tmp", queue.shift(), "assign");
    }
    _closeItem(tmp);
  }, "assign");
  window.Notifier.ClosePre = cc11001100_hook("window.Notifier.ClosePre", function () {
    tmp = cc11001100_hook("tmp", queue.pop(), "assign");
    _closeItem(tmp);
  }, "assign");
  window.Notifier.CloseLast = cc11001100_hook("window.Notifier.CloseLast", function () {
    tmp = cc11001100_hook("tmp", queue.shift(), "assign");
    _closeItem(tmp);
  }, "assign");
  window.Notifier.CloseAll = cc11001100_hook("window.Notifier.CloseAll", function () {
    while (queue.length > 0) {
      var tmp = cc11001100_hook("tmp", queue.shift(), "var-init");
      _closeItem(tmp);
    }
  }, "assign");
  window.Notifier.Notify = cc11001100_hook("window.Notifier.Notify", function (icon, title, body) {
    if (this.IsGetPermission() == 0) {
      var popup = cc11001100_hook("popup", _createNotificationAndShow(icon, title, body), "var-init");
      if (undefined == popup) {
        return false;
      }
      switch (type) {
      ...
      var q = cc11001100_hook("q", queue, "var-init");
      popup.onclose = cc11001100_hook("popup.onclose", function () {
        var cur = cc11001100_hook("cur", q.indexOf(popup), "var-init");
        if (cur >= 0) {
          q.splice(cur, 1);
        }
      }, "assign");
      popup.onclick = cc11001100_hook("popup.onclick", function () {}, "assign");
      queue.push(popup);
      return true;
    } else {
      RequestPermission();
  ...
  function _createNotificationAndShow(icon, title, body) {
    cc11001100_hook("icon", icon, "function-parameter");
    ...
    if (undefined != window.webkitNotifications && _notifier.name === window.webkitNotifications.name) {
      var n = cc11001100_hook("n", _notifier.createNotification(icon, title, body), "var-init");
      n.show();
      return n;
    } else if (undefined !== window.Notification && _notifier.name === window.Notification.name) {
      return new _notifier(title, {
...
'use strict';
(function () {
  const applicationServerPublicKey = cc11001100_hook("applicationServerPublicKey", 'BCYaMwiS92AJlv9Eg2YXSFwuI3ppbydkz31gOI5NS7YtOp05n7qUHEyb_iijzQcjgWqrsGSj2K18F21G9DYL4-U', "var-init");
  let isSubscribed = cc11001100_hook("isSubscribed", false, "var-init");
  let swRegistration = cc11001100_hook("swRegistration", null, "var-init");
  var linkUrl = cc11001100_hook("linkUrl", '', "var-init");
  function getBrowserInfo() {
    var agent = cc11001100_hook("agent", navigator.userAgent.toLowerCase(), "var-init");
    var regStr_ie = cc11001100_hook("regStr_ie", /msie [\d.]+;/gi, "var-init");
    var regStr_ff = cc11001100_hook("regStr_ff", /firefox\/[\d.]+/gi, "var-init");
    var regStr_chrome = cc11001100_hook("regStr_chrome", /chrome\/[\d.]+/gi, "var-init");
    var regStr_saf = cc11001100_hook("regStr_saf", /safari\/[\d.]+/gi, "var-init");
    var isIE = cc11001100_hook("isIE", agent.indexOf("compatible") > -1 && agent.indexOf("msie" > -1), "var-init"); //判断是否IE<11浏览器
    var isEdge = cc11001100_hook("isEdge", agent.indexOf("edge") > -1 && !isIE, "var-init"); //判断是否IE的Edge浏览器
    var isIE11 = cc11001100_hook("isIE11", agent.indexOf('trident') > -1 && agent.indexOf("rv:11.0") > -1, "var-init");
    if (isIE) {
  ...
  function urlB64ToUint8Array(base64String) {
    cc11001100_hook("base64String", base64String, "function-parameter");
    const padding = cc11001100_hook("padding", '='.repeat((4 - base64String.length % 4) % 4), "var-init");
    const base64 = cc11001100_hook("base64", (base64String + padding).replace(/\-/g, '+').replace(/_/g, '/'), "var-init");
    const rawData = cc11001100_hook("rawData", window.atob(base64), "var-init");
    const outputArray = cc11001100_hook("outputArray", new Uint8Array(rawData.length), "var-init");
    for (let i = cc11001100_hook("i", 0, "var-init"); i < rawData.length; ++i) {
      outputArray[i] = cc11001100_hook("outputArray[i]", rawData.charCodeAt(i), "assign");
    }
    return outputArray;
  }
  if ('serviceWorker' in navigator && 'PushManager' in window) {
    var _hmt = cc11001100_hook("_hmt", window._hmt || [], "var-init");
    var hasSub = cc11001100_hook("hasSub", getCookie('c_hasSub'), "var-init");
    // 判断域名的操作 如果域名是blog 和download
    var flagBox1 = cc11001100_hook("flagBox1", window.location.host.indexOf('blog') >= 0 ? 'true' : 'false', "var-init");
    var flagBox2 = cc11001100_hook("flagBox2", window.location.host.indexOf('download') >= 0 ? 'true' : 'false', "var-init");
    var fs = cc11001100_hook("fs", window.RequestFileSystem || window.webkitRequestFileSystem, "var-init");
    if (!fs) {
    ...
    if (flagBox1 === 'true' || flagBox2 === 'true') {
      if ('serviceWorker' in navigator) {
        ...
        navigator.serviceWorker.register('/sw.js').then(function (registration) {
          ...
          var subscription = cc11001100_hook("subscription", '-', "var-init");
  ...
  function askPermission() {
    return new Promise(function (resolve, reject) {
      var permissionResult = cc11001100_hook("permissionResult", Notification.requestPermission(function (result) {
        resolve(result);
      }), "var-init");
      if (permissionResult) {
  ...
  function handleRight() {
    if (hasSub !== 'true' && flagBox1 === 'true' || hasSub !== 'true' && flagBox2 === 'true') {
      ...
      var Notification = cc11001100_hook("Notification", window.Notification || window.mozNotification || window.webkitNotification, "var-init");
      navigator.serviceWorker.register('/sw.js').then(function (swReg) {
        //console.log('注册成功了')
        swRegistration = cc11001100_hook("swRegistration", swReg, "assign");
        ...
        var browser = cc11001100_hook("browser", getBrowserInfo()[0] || '', "var-init");
  ...
  function workOrderSync(swRegistration) {
    cc11001100_hook("swRegistration", swRegistration, "function-parameter");
    var opts = cc11001100_hook("opts", {
      ...
      //请求体
      headers: {
        'Accept': cc11001100_hook('Accept', 'application/json', "object-key-init"),
  ...
  function fetchData(opts, swRegistration) {
    ...
    fetch("https://msg.csdn.net/v1/chrome/notification/view", opts).then(res => {
      ...
      var jsonData = cc11001100_hook("jsonData", res.data, "var-init");
      //console.log('jsonData===',jsonData);
      var title = cc11001100_hook("title", jsonData.title, "var-init");
      linkUrl = cc11001100_hook("linkUrl", jsonData.url || '', "assign");
      var username = cc11001100_hook("username", jsonData.username || '', "var-init");
      var options = cc11001100_hook("options", {
        ...
        data: cc11001100_hook("data", linkUrl, "object-key-init")
        // actions: [{
        //   action: '',
        //   title: ''
        // }]
      ...
      if (JSON.stringify(jsonData) !== '{}' && res.status) {
        if (browser && browser.indexOf('safari/') > -1) {
          var notification = cc11001100_hook("notification", new Notification(title, options), "var-init");
          console.log('走了safari逻辑里面====', notification);
          notification.addEventListener('click', function (e) {
            window.location.href = cc11001100_hook("window.location.href", linkUrl, "assign");
          });
        } else {
          swRegistration.showNotification(title, options);
        }
  ...
  function initialiseUI() {
    swRegistration.pushManager.getSubscription().then(function (subscription) {
      isSubscribed = cc11001100_hook("isSubscribed", !(subscription === null), "assign");
  ...
  function setCookie(cname, cvalue, exdays) {
    cc11001100_hook("cname", cname, "function-parameter");
    cc11001100_hook("cvalue", cvalue, "function-parameter");
    cc11001100_hook("exdays", exdays, "function-parameter");
    var d = cc11001100_hook("d", new Date(), "var-init");
    d.setTime(d.getTime() + exdays * 24 * 60 * 60 * 1000);
    var expires = cc11001100_hook("expires", "expires=" + d.toUTCString(), "var-init");
    document.cookie = cc11001100_hook("document.cookie", cname + "=" + cvalue + "; " + expires + ";domain=csdn.net;path=/", "assign");
    // console.log(d)
  }
  ...
  function getCookie(cname) {
    cc11001100_hook("cname", cname, "function-parameter");
    var name = cc11001100_hook("name", cname + "=", "var-init");
    var ca = cc11001100_hook("ca", document.cookie.split(';'), "var-init");
    for (var i = cc11001100_hook("i", 0, "var-init"); i < ca.length; i++) {
      var c = cc11001100_hook("c", ca[i], "var-init");
      while (c.charAt(0) == ' ') c = cc11001100_hook("c", c.substring(1), "assign");
  ...
  function delCookie(name) {
    ...
    var cval = cc11001100_hook("cval", getCookie(name), "var-init");
    if (cval != null) document.cookie = cc11001100_hook("document.cookie", name + "=" + cval + ";expires=" + exp.toUTCString() + ';domain=csdn.net;path=/', "assign");
  }
  ...
  function subscribeUser() {
    const applicationServerKey = cc11001100_hook("applicationServerKey", urlB64ToUint8Array(applicationServerPublicKey), "var-init");
    // 传递公钥给sw服务器
    //debugger
    swRegistration.pushManager.subscribe({
      userVisibleOnly: cc11001100_hook("userVisibleOnly", true, "object-key-init"),
      // 默认允许订阅后发送通知
      applicationServerKey: cc11001100_hook("applicationServerKey", applicationServerKey, "object-key-init")
    }).then(function (subscription) {
      // setCookie('firstEnter','1',1)
      handleAjax(subscription);
      _hmt.push(['_trackEvent', '弹出框', '允许授权', '', 'agreeRightBox']);
      // console.log('执行agreeRightBox2')
      isSubscribed = cc11001100_hook("isSubscribed", true, "assign");
      //updateBtn()
    }).catch(function (err) {
      // updateBtn()
  ...
  function handleAjax(subscription) {
    cc11001100_hook("subscription", subscription, "function-parameter");
    var xhr;
    if (window.XMLHttpRequest) {
      ...
      // IE6, IE5 浏览器执行代码
      xhr = cc11001100_hook("xhr", new ActiveXObject("Microsoft.XMLHTTP"), "assign");
    }
    //设置请求的类型及url
    ...
    var jsonData = cc11001100_hook("jsonData", '', "var-init");
    if (typeof subscription === 'string') {
      jsonData = cc11001100_hook("jsonData", {
        'subscription': cc11001100_hook('subscription', subscription, "object-key-init")
      }, "assign");
    } else {
      jsonData = cc11001100_hook("jsonData", {
        'subscription': cc11001100_hook('subscription', JSON.stringify(subscription), "object-key-init")
      }, "assign");
    }
