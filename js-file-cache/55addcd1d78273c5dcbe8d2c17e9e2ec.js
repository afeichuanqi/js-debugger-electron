//tealium universal tag - utag.1329 ut4.0.202303230638, Copyright 2023 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    ...
    u.map = cc11001100_hook("u.map", {
      ...
      "_sm_1329_5:conversion": cc11001100_hook("_sm_1329_5:conversion", "conversion", "object-key-init"),
    ...
    u.extend = cc11001100_hook("u.extend", [function (a, b) {
      try {
        b['_sm_1329_5'] = cc11001100_hook("b['_sm_1329_5']", "conversion", "assign");
      } catch (e) {
        utag.DB(e);
      }
      ...
      if (1) {
        ...
        c = cc11001100_hook("c", [{
          '/mobile-services/cathay-pacific-app': cc11001100_hook('/mobile-services/cathay-pacific-app', 'DC-12146807|welln0|appdownl|standard', "object-key-init")
        }, {
          '/wellness-journey': cc11001100_hook('/wellness-journey', 'DC-12146807|welln0|wjintro|standard', "object-key-init")
        }, {
          '/sign-in': cc11001100_hook('/sign-in', 'DC-12146807|welln0|lifes00|standard', "object-key-init")
        }, {
          '/offers/vhis-and-cigna-plus.html': cc11001100_hook('/offers/vhis-and-cigna-plus.html', 'DC-12146807|welln0|vhisp|standard', "object-key-init")
        }], "assign");
      ...
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        if (!u.hasgtagjs()) {
          ...
          u.loader({
            ...
            "id": cc11001100_hook("id", "utag_1329", "object-key-init"),
            "attrs": {}
          });
        }
        utag.DB("send:1329:COMPLETE");
      }
    }, "assign");
