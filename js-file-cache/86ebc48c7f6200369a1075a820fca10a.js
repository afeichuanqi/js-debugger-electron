  ...
  */
  ...
  function Jn(a) {
    ...
    V.wa(b => {
      ...
      b.mjsv = cc11001100_hook("b.mjsv", "m202302220101", "assign");
  ...
  var fp = cc11001100_hook("fp", (a, b, c) => {
  ...
  var jp = cc11001100_hook("jp", (a, b, c) => {
    if (a && a.shift) {
  ...
  function op(a) {
    ...
    J(a, (b, c) => {
      li[c] || (delete a[c], n.console.warn(`AdSense head tag doesn't support ${c.replace("google", "data").replace(/_/g, "-")} attribute.`));
    });
  }
  var rp = cc11001100_hook("rp", (a, b) => {
    ...
    if (c) {
      ...
      if (d.head_tag_slot_vars) pp(c);else {
        ...
        e.google_adbreak_test || b.l()?.l() && T(ph) ? qp(f, a) : Xo(() => {
          qp(f, a);
        });
      }
    }
  ...
  var np = cc11001100_hook("np", (a, b, c, d) => {
  ...
  const Hp = cc11001100_hook("Hp", () => {
    for (const [a, b] of bp) -1 !== b && (n.clearTimeout(b), bp.delete(a));
    for (let a = cc11001100_hook("a", 0, "var-init"); a < ap.length; a++) {
  ...
  })("m202302220101", "undefined" === typeof sttc ? void 0 : sttc, function (a, b) {
